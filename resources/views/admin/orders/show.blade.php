    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-surface-800 rounded-2xl border border-surface-200 dark:border-surface-700 p-6">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <h2 class="text-xl font-display font-bold text-surface-800 dark:text-white flex items-center flex-wrap gap-2">
                        {{ $order->order_number }}
                        ...
                        <a href="{{ route('admin.returns.create', ['order_id' => $order->id]) }}" class="text-xs bg-rose-50 hover:bg-rose-100 dark:bg-rose-900/30 dark:hover:bg-rose-900/50 text-rose-600 dark:text-rose-400 px-3 py-1.5 rounded-lg flex items-center gap-1 transition-colors font-semibold">
                    ...
                    <p class="text-sm text-surface-500 mt-2">Placed {{ $order->created_at->format('M d, Y \a\t h:i A') }}</p>
                </div>
